<html>
	<head>
        <title>Registration Fee Slip - {{ $editData['student']['name'] }}</title>
        ...
        <div id="mainDocument">
            ...
            <section><!-- ==============================     FEE    ============================= -->
                <div class="section">
                    ...
                    <article>
                        <p class="workTitle">Study Feee</p>
                        <div class="workContent">
                            <table class="personal-table">
                                <tr>
                                    <td class="table-title-study">Registration Fee</td>
                                ...
                                <tr>
                                    @php
                                        $registrantion_fee = App\Models\FeeCategoryAmount::where('fee_category_id', 1)
