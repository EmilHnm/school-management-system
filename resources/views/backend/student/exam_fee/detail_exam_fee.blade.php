<html>
	<head>
        <title>Exam Fee Slip - {{ $editData['student']['name'] }}</title>
                ...
                <div class="section">
                    ...
                    <article>
                        ...
                        <div class="workContent">
                            <table class="personal-table">
                                <tr>
                                    <td class="table-title-study">Exam Fee</td>
                                    <td class="table-title-study">Discount Fee</td>
                                    <td class="table-title-study">Final Fee of {{ $exam_type_id }}</td>

                                </tr>
                                <tr>
                                    @php
                                        $registrantion_fee = App\Models\FeeCategoryAmount::where('fee_category_id', 3)
