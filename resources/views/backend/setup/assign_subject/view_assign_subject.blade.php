                        ...
                        <tbody>
                            @foreach ($allData as $index => $assign)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('assign.subject.edit', $assign->class_id) }}" class="btn btn-info mb-5">Edit</a>
                                        <a href="{{ route('assign.subject.detail', $assign->class_id) }}" class="btn btn-primary mb-5" >Details</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
