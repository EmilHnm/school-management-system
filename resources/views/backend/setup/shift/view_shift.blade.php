                        ...
                        <tbody>
                            @foreach ($allData as $index => $student)
                                <tr>
                                    ...
                                    <td>{{ $student->name }}</td>
                                    <td>
                                        <a href="{{ route('student.shift.edit',$student->id) }}" class="btn btn-info mb-5">Edit</a>
                                        <a href="{{ route('student.shift.delete',$student->id) }}" class="btn btn-danger mb-5" id="delete">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
