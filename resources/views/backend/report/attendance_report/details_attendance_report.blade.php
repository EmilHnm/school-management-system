<html>
	<head>
        <title>Employee Profile - {{ $attendance[0]['user']['name'] }}</title>
    ...
    <page size="A4"> <!-- Begin first page -->
        ...
        <div class="topBar">
            <div id="name">
                <h1 class="">Employee Attendence Report</h1>
                <h2 class="">
                    {{ $month }}
                </h2>
            </div>
        ...
        <div id="mainDocument">
            <section><!-- ==============================     STUDENT INFORMATION     ============================= -->
                <div class="section">
                        ...
                        <div class="workContent">
                            <table class="personal-table">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $attendance[0]['user']['gender'] }}</td>
                                </tr>
                                <tr>
                                    <td class="table-title">Date of Birht</td>
                                    <td>{{ $attendance[0]['user']['dob'] }}</td>
                                </tr>
                                <tr>
                                    <td class="table-title">Address</td>
                                    <td>{{ $attendance[0]['user']['address'] }}</td>
                                </tr>
                                <tr>
                                    <td class="table-title">Mobile Number</td>
                                    <td>{{ $attendance[0]['user']['mobile'] }}</td>
                                </tr>
                            </table>
                        </div>
                    </article>
                    <article>
                        <div class="rectangle"></div>
                        <p class="workTitle">Attendance - {{ $month }}</p>
                        <div class="workContent">
                            <table class="personal-table">
                                <tr>
                                    <td class="table-title">Absent Day:</td>
                                    <td>{{ $absents }}</td>
                                </tr>
                                <tr>
                                    <td class="table-title">Leave Day:</td>
                                    <td>{{ $leaves }}</td>
                                </tr>
                            </table>
                            <table class="personal-table">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="table-title">Attendance Status</td>
                                    </tr>
                                </thead>
                                <tbody>
