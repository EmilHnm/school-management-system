				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-white">Swallowtail School Manager</h2>
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							<form action="/register" method="post">
								...
								<div class="form-group">
                                    ...
                                    @error('name')
                                        <span style="width: 100%; color: red; font-weight: bold" role="alert">
                                            {{ $message }}
                                        </span>
                                    @enderror
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" input="email" name="email" :value="{{ old('email') }}" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
									</div>
                                    @error('email')
                                        <span style="width: 100%; color: red; font-weight: bold" role="alert">
                                            {{ $message }}
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Already have an account?<a href="/login" class="text-danger ml-5"> Sign In</a></p>
							</div>
						</div>
					</div>
				</div>
